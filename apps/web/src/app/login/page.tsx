    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">Sign in to Kaizen AI Marketing</p>
        </div>
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full py-2.5 rounded-lg border border-border text-foreground font-medium hover:bg-accent transition flex items-center justify-center gap-2"
          >
